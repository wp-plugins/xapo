...
By default the tip button will be added at the end of content, but optionally you can disable it and add it to your theme with <?php print_tip_btn(); ?>
...
= Version 0.2 =
* Updated SDK. It's no longer needed API Key. Just re-activate plugin, and just works.
